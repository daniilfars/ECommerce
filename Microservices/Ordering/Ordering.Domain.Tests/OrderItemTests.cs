...
public class OrderItemTests
{
    ...
    {
        var result = OrderItem.Create(1, "Phone", 999.99m, "RUB", 2, null);
    ...
    {
        var result = OrderItem.Create(1, "Phone", 100m, "RUB", 0, null);
    ...
    {
        var result = OrderItem.Create(1, "Phone", -10m, "RUB", 1, null);
